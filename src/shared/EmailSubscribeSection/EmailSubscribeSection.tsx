            ...
            >
              <div className="flex flex-col md:flex-row items-center gap-3 w-full">
                ...
                <div className="flex-shrink-0">
                  <button
                    className="flex items-center justify-center rounded-full bg-slate-900 hover:bg-slate-800 text-slate-50 px-6 py-3 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-6000 dark:focus:ring-offset-0"
                    type="submit"
                  >
                    Let's Connect
                  </button>
