                ...
                <div className="block mt-6">
                  <ul className="pl-5 dashed list-inside leading-7 text-md text-slate-500 dark:text-slate-400">
                    ...
                    <li>
                      ...
                      world. The need for quality Siddha medicines,
                      user-friendly traditional medicines & most importantly
                      side effect-free natural medicines has helped us grow
                      immensely.{" "}
                    </li>
                    <li>
                    ...
                    <li>
                      ...
                      huge boost to start our branches all over Tamilnadu and
                      soon all over India.
                    </li>
                    <li>
                    ...
                    <li>
                      ...
                      body, mind, and spirit with our range of wellness
                      solutions inspired by ancient traditions & delivered
